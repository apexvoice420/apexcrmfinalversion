...
import { Search, Plus, Phone, Mail, MoreVertical, Download } from 'lucide-react';
...
const demoLeads: Lead[] = [
  ...
  { id: '2', firstName: 'Sarah', lastName: 'Miller', phone: '+1 555-0102', email: 'sarah@email.com', status: 'CONTACTED', source: 'Call', createdAt: new Date(Date.now() - 86400000).toISOString() },
  { id: '3', firstName: 'Mike', lastName: 'Ross', phone: '+1 555-0103', email: 'mike@email.com', status: 'QUALIFIED', source: 'Call', createdAt: new Date(Date.now() - 172800000).toISOString() },
  { id: '4', firstName: 'Emma', lastName: 'Wilson', phone: '+1 555-0104', email: 'emma@email.com', status: 'BOOKED', source: 'Web', createdAt: new Date(Date.now() - 259200000).toISOString() },
  { id: '5', firstName: 'David', lastName: 'Brown', phone: '+1 555-0105', email: 'david@email.com', status: 'NEW', source: 'Referral', createdAt: new Date(Date.now() - 345600000).toISOString() },
  { id: '6', firstName: 'Lisa', lastName: 'Chen', phone: '+1 555-0106', email: 'lisa@email.com', status: 'CONTACTED', source: 'Call', createdAt: new Date(Date.now() - 432000000).toISOString() },
];
